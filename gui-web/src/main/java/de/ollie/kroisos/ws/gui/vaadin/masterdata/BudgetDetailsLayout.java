...
public class BudgetDetailsLayout extends AbstractMasterDataBaseLayout {
	...
	private final DetailsLayoutComboBoxItemLabelGenerator<Budget> comboBoxItemLabelGenerator;
	...
	public void onAttach(AttachEvent attachEvent) {
		...
		createButtons();
		textFieldKuerzel = createTextField("BudgetDetailsLayout.field.kuerzel.label", model.getKuerzel());
